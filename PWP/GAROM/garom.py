...
class Generator(nn.Module):
    def __init__(self, input_dimension, input_channels, parameters_dimension,
        ...
        self.lifting = torch.nn.Linear(1, input_channels)
...
class Discriminator(nn.Module):
    def __init__(self, input_dimension, input_channels, parameter_dimension,
...
class GAROM(object):
    ...
    def __init__(self, input_dimension, input_channels, hidden_dimension,
    ...
    def _train_began(self, train_loader, test_loader, generator, discriminator,
        ...
        train_loss_l1 = torch.zeros(int(np.ceil(4000/64)))
        test_loss_l1 = torch.zeros(128)
        test_loss_l2 = torch.zeros(128)
        ...
        for epoch in range(epochs):
            ...
            if test_error < best_model:
                ...
                print(f"Saving model with {test_error:.4f}% error.")
                torch.save(generator, "GAROM_FullBody.pt")
