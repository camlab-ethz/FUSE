        ...
        for epoch in range(num_epochs):
            ...
            with torch.no_grad():
                for X,Y in testloader:
                    ...
                    l1_errors[iter*nB:(iter+1)*nB] = relative_error(model(X, residual=residual, res_num=Y.shape[1]), Y, p=1)
                    l2_errors[iter*nB:(iter+1)*nB] = relative_error(model(X, residual=residual, res_num=Y.shape[1]), Y, p=2)
