...
class UNet(nn.Module):
    def __init__(self, n_parameters, FMPE_width, FMPE_layers, in_channels, latent_channels, out_channels):
        ...
        self.FMPE_in = FMPE(n_parameters, latent_channels*3*90, hidden_features=[FMPE_width] * FMPE_layers)
        self.loss_in = FMPELoss(self.FMPE_in)
        
        # lifting layers from xi to a
        self.fc1 = nn.Linear(n_parameters, latent_channels*3) 
        self.fs1 = nn.Linear(1, 90)
